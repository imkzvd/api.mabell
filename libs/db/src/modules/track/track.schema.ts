...
export class Track extends BaseSchema {
  ...
  @Prop({ required: true, type: Schema.Types.ObjectId, ref: 'Album', index: true })
  album: Types.ObjectId;

  @Prop({ required: true, type: Number })
  trackNumber: number;

  @Prop({ required: true, type: [{ type: Schema.Types.ObjectId, ref: Artist.name, index: true }] })
  artists: Types.ObjectId[];

  @Prop({ required: false, type: [{ type: Schema.Types.ObjectId, ref: Artist.name, index: true }] })
